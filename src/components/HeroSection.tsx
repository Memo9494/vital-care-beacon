        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          <div className="fade-in">
            ...
            <p className="text-lg md:text-xl text-gray-600 mb-8 max-w-xl">
              Con más de 10 años de experiencia, ofreciendo atención quirúrgica de excelencia en Monterrey, Nuevo León. Especialista en procedimientos mínimamente invasivos y cirugía avanzada.
            </p>
            ...
            <div className="mt-8 flex items-center gap-6">
              ...
              <div>
                <p className="text-3xl font-bold text-medical-blue">10+</p>
                <p className="text-sm text-gray-600">Años de Experiencia</p>
              </div>
              <div className="h-12 border-r border-gray-300"></div>
              <div>
                <p className="text-3xl font-bold text-medical-blue">200+</p>
